...
Output files: 
- rare_qced_del_gene-based_Fishers-CMH.txt: Gene-based test results (see [`rare_qced_del_gene-based_Fishers-CMH.txt.descriptor`](/Gene_based_test/rare_del_gene-based_Fishers-CMH.txt.descriptor))
