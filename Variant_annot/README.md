...
50. Missing_Call_Rate_Control : calculated from â€œNAâ€ genotype calls in control samples; for variant quality QC
51. Missing_Call_Rate_Case : calculated from â€œNAâ€ genotype calls in case samples; for variant quality QC
52. Missing_Call_Rate_All : calculated from â€œNAâ€ genotype calls in all samples; for variant quality QC
53. Filter : VQSR filter status; for variant quality QC
54. Control_NA : number of â€œNAâ€ (no calls or fail variant quality QC) genotype calls in control samples
55. Control_0 : number of â€œ0â€ (homozygous for reference allele) genotype calls in control samples
56. Control_1 : number of â€œ1â€ (heterozygous) genotype calls in control samples
57: Control_2 : number of â€œ2â€ (homozygous for alternate allele) genotype calls in control samples
58: Case_NA : number of â€œNAâ€ (no calls or fail variant quality QC) genotype calls in case samples
59. Case_0 : number of â€œ0â€ (homozygous for reference allele) genotype calls in case samples
60: Case_1 : number of â€œ1â€ (heterozygous) genotype calls in case samples
61: Case_2 : number of â€œ2â€ (homozygous for alternate allele) genotype calls in case samples
